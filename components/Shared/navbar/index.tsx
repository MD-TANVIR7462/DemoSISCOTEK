        ...
        <div className="flex h-20 items-center justify-between">
          <div className="flex items-center">
            <Link href="/" className="text-2xl font-bold hidden  sm:block">
              {/* <img src="https://i.ibb.co.com/zx9JSZs/SISCOTEK-LOGO-NEW-2025.png" alt="" /> */}
              <span className="text-2xl  text-white">SiSCO</span><span className="text-2xl text-purple-400">TEK</span>
            </Link>
          </div>

          <NavLinks onClose={() => setIsMobileMenuOpen(false)}  className="hidden md:flex" />
